...
function PrivacyPolicyPage() {
  return (
    <Layout>
      ...
      <Wrapper>
        <TitleBackground src="/images/waves/HeaderWave.svg"></TitleBackground>
        <ContentWrapper>
          <TextWrapper>
            <Title>Privacy Policy</Title>
            <p>Effective date: 2020-08-12</p>
            <Section>1. Introduction</Section>
            <Text>
              <p>Welcome to Code Shape.</p>
              <p>
                Code Shape (“us”, “we”, or “our”) operates codeshape.io
            ...
            <Text>
              <p>
                SERVICE means the codeshape.io website or apps operated by Code
                Shape.
              </p>
              <p>
            ...
            <Section>3. Information Collection and Use</Section>
            <Text>
              We collect several different types of information for various
              purposes to provide and improve our Service to you.
            </Text>
            <Section>4. Types of Data Collected</Section>
            <Text>
              ...
              <p>
                ...
                unique device identi"ers and other diagnostic data.
              </p>
              <p>
            ...
            <Section>6. Retention of Data</Section>
            <Text>
              <p>
            ...
            <Section>7. Transfer of Data</Section>
            <Text>
              <p>
                Your information, including Personal Data, may be transferred to
                – and maintained on – computers located outside of your state,
                province, country or other governmental jurisdiction where the
                data protection laws may difer from those of your jurisdiction.
              </p>
              <p>
                If you are located outside Denmark and choose to provide
                information to us, please note that we transfer the data,
                including Personal Data, to Denmark and process it there.
              </p>
              <p>
              ...
              <p>
                Code Shape will take all the steps reasonably necessary to
            ...
            <Section>8. Disclosure of Data</Section>
            <Text>
              <p>
            ...
            <Section>9. Security of Data</Section>
            <Text>
              <p>
            ...
            <Text>
              ...
              <ul>
                ...
                <li>
                  ...
                  emailing us at contact@codeshape.io.
                </li>
              </ul>
            ...
            <Section>13. Service Providers</Section>
            <Text>
              <p>
            ...
            <Section>15. CI/CD tools</Section>
            <Text>
              <p>
            ...
            <Section>16. Behavioral Remarketing</Section>
            <Text>
              <p>
            ...
            <Section>18. Links to Other Sites</Section>
            <Text>
              <p>
            ...
            <Section>19. Children’s Privacy</Section>
            <Text>
              <p>
              ...
              <p>
                ...
                veriffication of parental consent, we take steps to remove that
                information from our servers.
              </p>
            </Text>
            <Section>20. Changes to This Privacy Policy</Section>
            <Text>
              <p>
            ...
            <Text>
              <p>
                ...
                contact us by email: contact@codeshape.io.
              </p>
            </Text>
          </TextWrapper>
        </ContentWrapper>
